    ...
    <div className="mb-5 pb-5">
      ...
      <div className="carousel-item active" style={{backgroundImage: `url(${homeImg})`, opacity: 0.82}}>
        <div className="text-info carousel-caption flex-center">
          <h3 className="display-5">الرحلات القادمة</h3>
        </div>
      </div>
      ...
      <div className="container text-center mt-5 pt-5">
        <span className="display-6">الرحلات القادمة (من السعودية إلى اليمن)</span>
        <hr/>
      ...
      <div className="container text-center mt-5 pt-5">
        <span className="display-6">الرحلات القادمة (من اليمن إلى السعودية)</span>
        <hr/>
        <div className="container mx-auto row mt-2">
      ...
      <div className="container text-center mt-5 pt-5">
        <span className="display-6">الرحلات القادمة (بين المدن اليمنية)</span>
        <hr/>
        <div className="container mx-auto row mt-2">
